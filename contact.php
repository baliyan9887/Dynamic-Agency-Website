...
<head>
  <meta charset="utf-8">
  <title>Dujunction- Contact</title>
    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="module/php.html">PHP Module</a>
          </li>
          <li class="nav-item">
  ...
  <div class="intro intro-single route bg-image" >
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          <h2 class="intro-title mb-4">Contact us</h2>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6">
         <div class="input-group input-group-lg">
           ...
           <input type="text" name="username" class="form-control" aria-describedby="sizing-addon1" placeholder="Full name">
         </div>
         <div class="input-group input-group-lg">
           <span class="input-group-addon" id="sizing-addon1"><i class="fa fa-envelope" style="margin-left: -10px;"></i></span>
           <input type="text" name="username" class="form-control" aria-describedby="sizing-addon1" placeholder="Your Email">
         </div>
         <div class="input-group input-group-lg">
           <span class="input-group-addon" id="sizing-addon1"><i class="fa fa-mobile-phone" style="margin-right: 5px;"></i></span>
           <input type="text" name="username" class="form-control" aria-describedby="sizing-addon1" placeholder="Phone Number">
         </div>

        </div>
        <div class="col-lg-6 col-md-6">
          <div class="input-group input-group-lg">
           <textarea class="form-control" name="msg" id="msg" cols="80" rows="6" placeholder="Message" style="height: 120px;"></textarea>
         </div>
